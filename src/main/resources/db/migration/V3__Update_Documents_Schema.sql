...
-- Agregar campos específicos para facturas SIFEN

-- Agregar campos específicos a la tabla documents
...
-- Crear tabla de clientes de documentos
...
-- Actualizar tabla document_items para campos específicos
...
-- Actualizar tabla document_payments para campos específicos
